...
<div id="page">
			...
			<h2 id="post-12" class="storytitle"><a href="http://www.johnbaylor.org/2007/09/29/d-efine-for-twitter-step-1/" rel="bookmark" title="Permanent link to d efine for twitter – step 1">d efine for twitter – step 1</a></h2>
			<p class="meta">Posted in <a href="http://www.johnbaylor.org/category/ruby/" title="View all posts in ruby" rel="category tag">ruby</a> at 2:55 pm by JohnB</p>
...
<p>That’s all.  You’ll have to wait for the twitter-integration piece in my next post.  I haven’t written it yet, but given the functionality in <a href="http://twitter4r.rubyforge.org/" title="twitter API for Ruby" target="_blank">twitter4r</a>, I doubt it will be much longer than the efine() method above.  In fact, my usual peeve about Ruby is just that: it takes longer to describe the code than to write it!</p>
			...
			<p class="feedback">
			<a href="http://www.johnbaylor.org/2007/09/29/d-efine-for-twitter-step-1/" rel="bookmark" title="Permanent link to d efine for twitter – step 1" class="permalink">Permalink</a>
						</p>
