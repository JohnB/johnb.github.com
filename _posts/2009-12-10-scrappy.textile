...
<div id="page">
			...
			<h2 id="post-75" class="storytitle"><a href="http://www.johnbaylor.org/2009/12/10/scrappy/" rel="bookmark" title="Permanent link to Scrappy">Scrappy</a></h2>
			<p class="meta">Posted in <a href="http://www.johnbaylor.org/category/ruby/" title="View all posts in ruby" rel="category tag">ruby</a> at 11:55 am by JohnB</p>
...
<p>The true test will be when I actually implement the code to support such a construct. Look for a <em>johnb/scrappy</em> project on Github. Until then, I’ll just assume it works! <img src="http://www.johnbaylor.org/wp-includes/images/smilies/icon_wink.gif" alt=";-)" class="wp-smiley"></p>
			...
			<p class="feedback">
			<a href="http://www.johnbaylor.org/2009/12/10/scrappy/" rel="bookmark" title="Permanent link to Scrappy" class="permalink">Permalink</a>
						</p>
